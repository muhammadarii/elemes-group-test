        ...
        <div>
          ...
          <div className="flex-col flex md:grid md:grid-cols-2 mt-[150px] md:mt-[96px] text-black ml-10 md:mx-[120px] font-rubik ">
            ...
            <div className="relative flex flex-col justify-start md:justify-center items-start mt-10">
              ...
              <div>
                <div className="absolute bg-[#F2F2F2] bottom-[220px] right-[80px] md:bottom-[37.88px] md:right-[447px] z-30 w-[292px] h-[93px] rounded-[17px] opacity-80 backdrop-blur-[500px] shadow-md"></div>
                <div className="absolute flex flex-row justify-start items-center bottom-[220px] right-[80px] md:bottom-[37.88px] md:right-[447px] z-30 w-[292px] h-[93px]">
                  <Image
                    src={Hero}
                    alt="image"
